...
Import-Module "C:\ProgramData\Syncro\DrOsdicks\bin\DrModuleV4.psm1" -DisableNameChecking

Initialize-Job "v4 Save-ApiKey" -NoNewTicket

Add-LogEntry "API key has been saved." -Icon 'lockandkey' -Buffer $Global:DrLogSummaryBuffer -FlushBuffer

#Add-LogEntry "📤 DrModuleV4 has been downloaded" -Icon 'download' -Buffer $Global:DrLogSummaryBuffer -
